  ...
  <div class="example-full">
              ...
              <td>
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a v-else-if="file.error && file.error !== 'compressing' && file.error !== 'image parsing' && $refs.upload.features.html5" class="dropdown-item" href="#" @click.prevent="$refs.upload.update(file, {active: true, error: '', progress: '0.00'})">Retry upload</a>
                    <a v-else :class="{'dropdown-item': true, disabled: file.success || file.error === 'compressing' || file.error === 'image parsing'}" href="#" @click.prevent="file.success || file.error === 'compressing' || file.error === 'image parsing' ? false : $refs.upload.update(file, {active: true})">Upload</a>
    ...
    <div v-show="isOption" class="option">
      ...
      <div class="form-group">
        ...
        <!-- <small v-if="autoCompress > 0" class="form-text text-muted">More than {{ $formatSize(autoCompress) }} files are automatically compressed</small> -->
      ...
      <div class="form-group">
        <div class="form-check">
          <label class="form-check-label">
            <input id="create-directory" v-model="createDirectory" type="checkbox" class="form-check-input"> Create Directory
          </label>
        </div>
              ...
              <div v-if="editFile.show && editFile.blob && editFile.type && editFile.type.substr(0, 6) === 'image/'" class="form-group">
                ...
                <div class="edit-image-tool">
                  <div class="btn-group" role="group">
                    <button type="button" class="btn btn-primary" title="cropper.rotate(-90)" @click="editFile.cropper.rotate(-90)">
                  ...
                  <div class="btn-group" role="group">
                    <button type="button" class="btn btn-primary" title="cropper.crop()" @click="editFile.cropper.crop()">
                      <i class="fa fa-check" aria-hidden="true" />
                    </button>
                    <button type="button" class="btn btn-primary" title="cropper.clear()" @click="editFile.cropper.clear()">
